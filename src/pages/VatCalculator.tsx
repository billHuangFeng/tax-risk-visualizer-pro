    ...
    <>
      ...
      >
        ...
        <VatSummary 
          ...
          salesDifferenceFactors={vatCalculator.salesDifferenceFactors}
          addSalesDifferenceFactor={vatCalculator.addSalesDifferenceFactor}
          updateSalesDifferenceFactor={vatCalculator.updateSalesDifferenceFactor}
          removeSalesDifferenceFactor={vatCalculator.removeSalesDifferenceFactor}
          purchasesDifferenceFactors={vatCalculator.purchasesDifferenceFactors}
          addPurchasesDifferenceFactor={vatCalculator.addPurchasesDifferenceFactor}
          updatePurchasesDifferenceFactor={vatCalculator.updatePurchasesDifferenceFactor}
          removePurchasesDifferenceFactor={vatCalculator.removePurchasesDifferenceFactor}
