...
const infoData = {
  ...
  insuranceExpenses: {
    ...
    analysis: "《中华人民共和国企业所得税法实施条例》第三十五�� 自2008年1月1日起，企业根据国家有关政策规定，为在本企业任职或者受雇的全体员工支付的补充养老保险费、补充医疗保险费，分别在不超过职工工资总额5%标准内的部分，在计算应纳税所得额时准予扣除；超过的部分，不予扣除。",
